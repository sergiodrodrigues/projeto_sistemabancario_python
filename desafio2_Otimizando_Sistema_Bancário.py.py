...
# Constantes para limites e informações bancárias
LIMITE_SAQUES = 3
AGENCIA = "0001"
LIMITE_VALOR_SAQUE = 500

# Função principal que executa o loop do menu e operações
def main():
    saldo = 0  # Saldo inicial da conta
    extrato = ""  # Extrato de transações vazio
...
# Função para listar as contas bancárias cadastradas
